...
function Prcs_d0304_WaterFlowStart(degree_y, rail_name, rail_direction, ride_start)
  ...
  if Flg.Check("FLAG_MAIN_10_001") then
    if not Flg.Check("FLAG_FIELD_D0304_RAIDTALK01_FIRST") then
      Message("f_d0304_0060_0010")
      Flg.Set("FLAG_FIELD_D0304_RAIDTALK01_FIRST")
    end
  elseif not Flg.Check("FLAG_FIELD_D0304_RAIDTALK02_FIRST") then
    Message("f_d0304_0050_0010")
    Flg.Set("FLAG_FIELD_D0304_RAIDTALK02_FIRST")
  end
  Field_Talk_End()
  Field_InvisibleFollowerAllPartyMember(0, 0, false)
  Field_InvisibleFollowerAllGuest(0, 0, false)

...
function Battle_Start(info)
  ...
  if 50 < enemy_level then
    ...
    Battle.UpgradeSkill(ENEMY_DIGIMON, 0, 30161, 30163)
    Battle.UpgradeSkill(ENEMY_DIGIMON, 0, 30245, 30246)
    Battle.UpgradeSkill(GUEST_DIGIMON, 0, 30081, 30083)
    Battle.UpgradeSkill(GUEST_DIGIMON, 0, 30141, 30143)
    Battle.UpgradeSkill(GUEST_DIGIMON, 0, 30191, 30193)
    Battle.UpgradeSkill(GUEST_DIGIMON, 0, 30201, 30203)
    Battle.UpgradeSkill(GUEST_DIGIMON, 0, 30321, 30323)
    Battle.UpgradeSkill(GUEST_DIGIMON, 1, 30071, 30073)
    Battle.UpgradeSkill(GUEST_DIGIMON, 1, 30081, 30083)
    Battle.UpgradeSkill(GUEST_DIGIMON, 1, 30141, 30143)
    Battle.UpgradeSkill(GUEST_DIGIMON, 1, 30201, 30203)
    Battle.UpgradeSkill(GUEST_DIGIMON, 1, 30321, 30323)
  end
end
...
function Battle_Turn_End(info)
  ...
  elseif Flg.Check("Battle5102") == false and Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_DAMAGE_MAGIC, 0, ENEMY_DIGIMON, 0, 14) and enemy_now_hp / enemy_max_hp < 0.4 then
    Battle.SetIsDisableBuffRemoval(ENEMY_DIGIMON, 0, false)

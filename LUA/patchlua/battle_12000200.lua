...
function Battle_Turn_Start(info)
  ...
  elseif Flg.Check("Battle5405") then
    ...
    BtlPlayDissolve(EFF_IN_04)
    BtlPlayDissolve(EFF_IN_05)
    BtlPlayDissolve(EFF_IN_06)
    WaitFrame(35)
    BtlPlayAnimation(GUEST_DIGIMON, 0, "ba02", 0, false)
    BtlPlayAnimation(GUEST_DIGIMON, 1, "ba02", 0, false)
    BtlPlayAnimation(GUEST_DIGIMON, 2, "ba02", 0, false)
  ...
  elseif Flg.Check("Battle5406") then
    ...
    BtlPlayDissolve(EFF_IN_07)
    BtlPlayDissolve(EFF_IN_08)
    BtlPlayDissolve(EFF_IN_09)
    WaitFrame(35)
    BtlPlayAnimation(GUEST_DIGIMON, 0, "ba02", 0, false)
    BtlPlayAnimation(GUEST_DIGIMON, 1, "ba02", 0, false)
    BtlPlayAnimation(GUEST_DIGIMON, 2, "ba02", 0, false)
  ...
  if Flg.Check("Battle5001") == false then
    if enemy_last_skill_id == 28047 and Battle.IsEndAnnouncementMessage(1) == false then
  ...
  if Battle.IsChronodevolution() == true then
    if Round_ph3 == 1 and info.group == GUEST_AEGIOMON and Battle.GetDigimonId(GUEST_AEGIOMON, 0) == AEGIOMON_ID then
  ...
  if info.group == GUEST_DIGIMON and info.digimon_id == 747 then
  ...
  if Flg.Check("Battle5004") and Flg.Check("Battle5053") then
    if info.group == 2 and info.index == 1 then
  ...
  if info.group == GUEST_DIGIMON and info.digimon_id == 999 then
    local aegiomon_hp = Battle.GetStatus(GUEST_AEGIOMON, 0, STATUS_TYPE_HP)
    if aegiomon_hp < 1 then
      Battle.SetNextCommandSkill(GUEST_DIGIMON, info.index, 31032)
      Battle.SetNextCommandTarget(GUEST_DIGIMON, info.index, GUEST_AEGIOMON, 0)
    end
  end
  ...
  if Flg.Check("Battle5008") then
    if Battle.IsEndAnnouncementMessage(42) == false then
      Battle.EntryAnnouncementMessage(42)
    elseif Battle.IsEndAnnouncementMessage(92) == true and Battle.IsEndAnnouncementMessage(51) == false then
      Battle.EntryAnnouncementMessage(51)
    elseif Battle.IsEndAnnouncementMessage(110) == true and Battle.IsEndAnnouncementMessage(60) == false then
      Battle.EntryAnnouncementMessage(60)
    end
  end
  if is_high_difficulty then
    if Flg.Check("Battle5117") and not Flg.Check("Battle5004") then
      if Battle.GetStatus(GUEST_DIGIMON, 1, STATUS_TYPE_LV) ~= 99 then
        Battle.SetStatus(GUEST_DIGIMON, 1, STATUS_TYPE_LV, 99)
        Battle.SetStatus(GUEST_DIGIMON, 2, STATUS_TYPE_LV, 99)
      end
    elseif Flg.Check("Battle5004") and not Flg.Check("Battle5119") then
      if Battle.GetStatus(GUEST_DIGIMON, 1, STATUS_TYPE_LV) ~= 99 then
        Battle.SetStatus(GUEST_DIGIMON, 1, STATUS_TYPE_LV, 99)
      end
    elseif Flg.Check("Battle5119") and Battle.GetStatus(GUEST_DIGIMON, 1, STATUS_TYPE_LV) ~= 99 then
      Battle.SetStatus(GUEST_DIGIMON, 1, STATUS_TYPE_LV, 99)
    end
  end
end
...
function Battle_Command_Start(info)
  ...
  if Flg.Check("Battle5004") and enemy_id == BOSS_ID then
    print("===== PHASE4 Chronomon TURN =====")
  ...
  if (enemy_last_skill_id == 70005 or skill_id == 70005) and Flg.Check("Battle5004") == true then
    print("##### PHASE4 CHARGE #####")
...
function Battle_Action_Start(info)
  ...
  if info.group == GUEST_DIGIMON and info.digimon_id == 181 then
    local skill_id = Battle.GetLastCommandSkillID()
    if (skill_id == 21813 or skill_id == 21814) and info.use_count == 0 then
      Battle.SetBattleSpeedToNormalForTurn()
    end
  elseif info.group == ENEMY_DIGIMON and info.enemy_id == BOSS_ID then
    local skill_id = Battle.GetLastCommandSkillID()
    if (skill_id == 48041 or skill_id == 48043 or skill_id == 48044 or skill_id == 48045 or skill_id == 48131 or skill_id == 48132 or skill_id == 48141 or skill_id == 28045 or skill_id == 28048) and info.use_count == 0 then
      Battle.SetBattleSpeedToNormalForTurn()
    end
  end
end
...
function Battle_Turn_End(info)
  ...
  if Flg.Check("Battle5001") == false then
    ...
    if Flg.Check("Battle5102") == false then
      if Flg.Check("Battle5215") == true then
        ...
        if Flg.Check("FLAG_IS_CLEAR_S110_098") == false then
          ...
          local enemy_now_hp = Battle.GetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_HP)
          local hp = enemy_now_hp - enemy_max_hp * 0.02
          ...
          Fade.In(1, Util.SecondFromFrame(30))
          local enemy_now_hp = Battle.GetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_HP)
          local hp = enemy_now_hp - enemy_max_hp * 0.05
          Battle.SetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_HP, hp)
          Battle.RemoveBuff(ENEMY_DIGIMON, 0, 580401)
          Battle.RemoveBuff(ENEMY_DIGIMON, 0, 580402)
          Battle.RemoveBuff(ENEMY_DIGIMON, 0, 580417)
    ...
    elseif Flg.Check("Battle5102") == true and enemy_last_skill_id == 28050 and Flg.Check("Battle5008") == false then
      ...
      BtlPlayAnimation(GUEST_DIGIMON, 0, "bn02", 0, true)
      ...
      BtlPlayDissolve(EFF_OUT_00, false)
      WaitFrame(30)
  ...
  if Flg.Check("Battle5010") and Flg.Check("Battle5116") == false and (info.group == PLAYER_DIGIMON or info.group == GUEST_AEGIOMON) then
    print("##### Phase3 setup #####")
  ...
  if Flg.Check("Battle5003") and Flg.Check("Battle5004") == false then
    if Flg.Check("Battle5117") == false then
      if skill_id == 28045 and Flg.Check("Battle5117") == false then
        ...
        Battle.ReadyNextSceneForVista()
        Execute("m440_033")
        Battle.SetBattleCamera(BATTLE_CAMERA_ID_TARGET_ENEMY_ALL, ENEMY_DIGIMON, 0)
        Fade.In(1, Util.SecondFromFrame(30))
        CoverFirePlay()
        Battle.SetIsIntervalDamage(false)
  ...
  if Flg.Check("Battle5004") then
    if Flg.Check("Battle5119") == false then
      if Battle.IsEndAnnouncementMessage(150) == true and info.group == GUEST_DIGIMON and info.digimon_id == 747 and Battle.IsEndAnnouncementMessage(151) == false then
    ...
    if enemy_now_hp == 1 and Flg.Check("Battle5119") == true then
      ...
      Fade.In(1, Util.SecondFromFrame(30))
      WaitFrame(30)
      Battle.EntryAnnouncementMessage(154)
      while Battle.IsEndAnnouncementMessage(154) == false do
        WaitFrame(1)
      end
  ...
  if Flg.Check("Battle5004") then
    ...
    local weak_damage_num = enemy_max_hp * 0.03
    if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_WAKE_DAMAGE_VALUE_OVER, 3, ENEMY_DIGIMON, 0, weak_damage_num) then
      Flg.Set("Battle5015")
    end
    local total_damage_num = enemy_max_hp * 0.05
    if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_DAMAGE_VALUE_OVER, 4, ENEMY_DIGIMON, 0, total_damage_num) then
      Flg.Set("Battle5016")
    end
    if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_HIT_COUNT_OVER, 3, ENEMY_DIGIMON, 0, 25) then
      Flg.Set("Battle5017")
    end
  end
  if Battle.IsTurnCharacterExtraTurn() == false then
    if skill_id == 70007 and Flg.Check("Battle5412") == true then
      Flg.Clear("Battle5412")
    end
    if Flg.Check("Battle5412") == true then
      Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 70007)
    elseif Flg.Check("Battle5008") and Flg.Check("Battle5001") == false then
    ...
    elseif Flg.Check("Battle5001") and Flg.Check("Battle5002") == false then
      ...
      if 1 <= random and random <= 40 then
        Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 48043)
      elseif random >= 41 and random <= 65 then
        Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 48044)
      elseif random >= 66 and random <= 90 then
        Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 48041)
  ...
  if stock_num == 0 or Flg.Check("Battle5053") or Flg.Check("Battle5412") then
    print("##### ExtraTurn_OFF #####")
  ...
  if Flg.Check("Battle5411") then
    if Flg.Check("Battle5001") == false then
      ...
      Battle.SetModelPosition(GUEST_DIGIMON, 2, 4.98, 0, 46.73)
      BtlPlayAnimation(GUEST_DIGIMON, 0, "bn02", 0, true)
      BtlPlayAnimation(GUEST_DIGIMON, 1, "bn02", 0, true)
      BtlPlayAnimation(GUEST_DIGIMON, 2, "bn02", 0, true)
      Battle.SetVisibleCharacter(GUEST_DIGIMON, 0, true)
      ...
      BtlPlayDissolve(EFF_OUT_01, false)
      BtlPlayDissolve(EFF_OUT_02, false)
      BtlPlayDissolve(EFF_OUT_03, false)
      WaitFrame(30)
      Battle.ExchangeMemberForDeleteTimingNextTurn(GUEST_DIGIMON, 0)
      Battle.ExchangeMemberForDeleteTimingNextTurn(GUEST_DIGIMON, 1)
      Battle.ExchangeMemberForDeleteTimingNextTurn(GUEST_DIGIMON, 2)
    ...
    elseif Flg.Check("Battle5001") and Flg.Check("Battle5002") == false then
      ...
      BtlPlayDissolve(EFF_OUT_04, false)
      BtlPlayDissolve(EFF_OUT_05, false)
      BtlPlayDissolve(EFF_OUT_06, false)
      WaitFrame(30)
      Battle.ExchangeMemberForDeleteTimingNextTurn(GUEST_DIGIMON, 0)
      Battle.ExchangeMemberForDeleteTimingNextTurn(GUEST_DIGIMON, 1)
      Battle.DeleteMember(GUEST_DIGIMON, 2)
    ...
    elseif Flg.Check("Battle5010") == false then
      ...
      Battle.SetVisibleCharacter(GUEST_DIGIMON, 1, true)
      WaitFrame(30)
      Battle.LoadDissolveChangeOut(EFF_OUT_07, GUEST_DIGIMON, 0)
      Battle.LoadDissolveChangeOut(EFF_OUT_08, GUEST_DIGIMON, 1)
      while Battle.IsLoadingDissolve(EFF_OUT_07) and Battle.IsLoadingDissolve(EFF_OUT_08) do
        WaitFrame(1)
      end
      Battle.PlayDissolve(EFF_OUT_07, false)
      Battle.PlayDissolve(EFF_OUT_08, false)
      WaitFrame(30)
      Battle.DeleteMember(GUEST_DIGIMON, 0)
      Battle.DeleteMember(GUEST_DIGIMON, 1)
      Flg.Set("Battle5010")
  ...
  local enemy_max_hp_f1 = Battle.GetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_HP_MAX) + enemy_max_hp * 0.9
  local enemy_now_hp_f1 = Battle.GetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_HP) + enemy_max_hp * 0.9
  if enemy_now_hp_f1 / enemy_max_hp_f1 <= 0.77 then

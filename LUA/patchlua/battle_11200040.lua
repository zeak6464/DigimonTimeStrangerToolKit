...
function Battle_Command_Start(info)
  ...
  if enemy_id == 88101 then
    if 0.85 <= enemy_now_hp / enemy_max_hp then
    ...
    elseif 0.6 <= enemy_now_hp / enemy_max_hp and enemy_now_hp / enemy_max_hp < 0.85 then
      if round_count % 2 == 0 then
        Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 48823)
    ...
    elseif 0.3 <= enemy_now_hp / enemy_max_hp and enemy_now_hp / enemy_max_hp < 0.6 then
  ...
  if enemy_id == 88101 then
    if enemy_now_hp / enemy_max_hp <= 0.85 and Flg.Check("Battle5001") == false then
      Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 40001)
      Flg.Set("Battle5001")
    elseif enemy_now_hp / enemy_max_hp <= 0.6 and Flg.Check("Battle5002") == false then
      Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 40002)
      Battle.RemoveBuff(ENEMY_DIGIMON, 0, 208002)
      Flg.Set("Battle5002")
    elseif enemy_now_hp / enemy_max_hp <= 0.3 and Flg.Check("Battle5003") == false then

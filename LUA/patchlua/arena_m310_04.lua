...
function arena_m310_04()
  ...
  LoadModel("enemy_01", "char_SUPERSTARMON")
  LoadModel("enemy_02", "char_PRINCEMAMEMON")
  LoadModel("enemy_03", "char_KINGETEMON")
  ...
  SetPosition("enemy_03", -8.688, 0, 3.029, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 90, 0, "LINEAR", 0, 0)
  ...
  PlayMotion("enemy_03", "bn01", 0, true, 0)
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  ...
  BlendFaceDigi("enemy_03", 0, 0, 0, "SCURVE", 0, 0)
  SetCamera(-33.719, 22.895, -4.736, -10, 40, "LINEAR", 0, false, 0, false)
  SetCameraTarget(9.201, 10.993, 0.471, "LINEAR", 0, false, 0, false)
  SetCamera(-19.382, 5.118, 24.855, -10, 40, "SCURVE", 180, true, 0, false)
  SetCameraTarget(4.609, 24.63, -4.998, "SCURVE", 180, true, 0, false)
  SetCamera(-15.081, 0.385, 33.732, -10, 40, "DECEL", 200, true, 175, false)
  SetCameraTarget(3.231, 24.821, -6.639, "DECEL", 200, true, 175, false)
  FIELD_SET()
  EVENT_START()
  CUT("1.0")
  SetEnv_All("c1.0", 0)
  ...
  MessageTalk("arena01_m310_040_010")
  MessageClose()
  WaitFrame(10)
  CUT("2.0")
  SetEnv_All("c3.0", 0)
  ...
  WaitFrame(10)
  MessageTalk("arena01_m310_040_020")
  MessageClose()
  WaitFrame(10)
  CUT("3.0")
  SetEnv_All("c2.0", 0)
  ...
  ModelVisible("enemy_03", true, 0, 0)
  ...
  SetPosition("enemy_03", -2.686, 0, -8.308, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 15, 0, "LINEAR", 0, 0)
  SetCamera(8.851, 0.01, -16.375, 0, 18, "LINEAR", 0, false, 0, false)
  SetCameraTarget(-0.507, 1.535, -6.701, "LINEAR", 0, false, 0, false)
  SetCamera(10.591, 0.01, -4.505, 0, 18, "SCURVE", 60, false, 0, false)
  SetCameraTarget(-0.507, 1.535, -7.771, "SCURVE", 60, false, 0, false)
  SetCamera(10.891, 0.01, -1.265, 0, 18, "LINEAR", 150, true, 60, false)
  SetCameraTarget(-0.507, 1.535, -7.821, "LINEAR", 150, true, 60, false)
  WaitFrame(10)
  MessageTalk("arena01_m310_040_030")
  MessageClose()
  WaitFrame(10)
  CUT("4.0")
  SetEnv_All("c2.0", 0)
  ...
  ModelVisible("enemy_02", true, 0, 0)
  ModelVisible("enemy_03", true, 0, 0)
  SetPosition("enemy_01", 1.39, 0, -8, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 0, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -0.329, 0, -7, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 11.5, 0, "LINEAR", 0, 0)
  SetPosition("enemy_03", -2.408, 0, -6.5, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 15, 0, "LINEAR", 0, 0)
  SetCamera(0.58, 1.493, -2.98, 0, 45, "LINEAR", 0, true, 0, false)
  SetCameraTarget(-1.666, 0.9, -12.706, "LINEAR", 0, true, 0, false)
  WaitFrame(10)
  PlayMotion("enemy_02", "fe02", 10, true, 0)
  PlayMotion("enemy_02", "bn01", 10, true, 90)
  WaitFrame(10)
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_m310_040_040")
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  PlayMotion("enemy_01", "fe02", 10, true, 0)
  PlayMotion("enemy_01", "bn01", 10, true, 55)
  WaitFrame(10)
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_m310_040_041")
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  PlayMotion("enemy_03", "fe02", 10, true, 0)
  PlayMotion("enemy_03", "bn01", 10, true, 65)
  WaitFrame(10)
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_m310_040_042")
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(20)
  CUT("5.0")
  ...
  SetPosition("enemy_03", -2.5, 0, -5.809, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 12, 0, "LINEAR", 0, 0)
  BlendEye("HEROINE_01", 0, 0, "SCURVE", 0, 0)
  ...
  SetCameraTarget(0, 4.3, 0, "DECEL", 10, false, 0, false)
  SetCamera(32.268, 1.53, 0, 0, 33, "LINEAR", 150, true, 10, false)
  SetCameraTarget(0, 4.3, 0, "LINEAR", 150, true, 10, false)
  Vista.ApplyVoiceSnapshot(SOUND_SNAPSHOT_MIC)
  MessageTalk("arena01_m310_040_050")
  MessageClose()
  WaitFrame(15)

...
function Battle_Opening(info)
  ...
  if Flg.Check("Battle5499") == false then
    ...
    if 1 <= random and random <= 35 then
      Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 2, 6902, enemy_level)
      Flg.Set("Battle5001")
      Flg.Set("Battle5491")
    elseif 36 <= random and random <= 65 then
      Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 2, 11302, enemy_level)
      Flg.Set("Battle5001")
      Flg.Set("Battle5492")
    elseif 66 <= random and random <= 85 then
      Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 2, 75302, enemy_level)
      Flg.Set("Battle5001")
      Flg.Set("Battle5493")
    elseif 86 <= random and random <= 100 then
      Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 2, 37402, enemy_level)
      Flg.Set("Battle5001")
      Flg.Set("Battle5494")
    end
...
function Battle_Turn_Start(info)
  ...
  if Flg.Check("Battle5003") and Flg.Check("Battle5201") == false then
    if Flg.Check("Battle5491") then
      ...
      Battle.AddBuff(ENEMY_DIGIMON, 2, 131060)
    elseif Flg.Check("Battle5492") then
      Battle.SetNextCommandSkill(ENEMY_DIGIMON, 2, 40010)
      Battle.AddBuff(ENEMY_DIGIMON, 2, 131050)
    elseif Flg.Check("Battle5493") then

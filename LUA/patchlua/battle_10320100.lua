...
function Battle_After_Setup()
  ...
  Battle.MotionNameOverwrite(ENEMY_PLAYER, 0, MOTION_TYPE_ITEM_02, "bn01")
  Battle.MotionNameOverwrite(ENEMY_PLAYER, 0, MOTION_TYPE_ATTACK02, "bn01")
  Battle.MotionNameOverwrite(ENEMY_PLAYER, 0, MOTION_TYPE_CHANGE_EXIT, "bn01")
  Battle.MotionNameOverwrite(ENEMY_PLAYER, 0, MOTION_TYPE_CHANGE_FOR_DEATH, "bn01")
end

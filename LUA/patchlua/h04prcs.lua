...
function Prcs_h04_BossBattle()
  ...
  WaitFrame(30)
  if gMapNum == 415 then
    EncountFromField_NormalEffect(5041507, 20471, true)
  elseif gMapNum == 416 then
    EncountFromField_NormalEffect(5041604, 20471, true)
  elseif gMapNum == 417 then
    EncountFromField_NormalEffect(5041704, 20471, true)
  elseif gMapNum == 418 then
    EncountFromField_NormalEffect(5041805, 20471, true)
  end
...
function Prcs_h04_BossBattle2()
  ...
  WaitFrame(30)
  if gMapNum == 420 then
    EncountFromField_NormalEffect(29001630, 20471, true)
  elseif gMapNum == 421 then
    EncountFromField_NormalEffect(29001640, 20471, true)
  elseif gMapNum == 422 then
    EncountFromField_NormalEffect(29001650, 20471, true)
  elseif gMapNum == 423 then
    EncountFromField_NormalEffect(29001660, 20471, true)
  end
  Cam.Follower:ResetFromRotation(0)
  Cam.Inst:Clear(0)
  PostEffect.SetZoomBlur(false)

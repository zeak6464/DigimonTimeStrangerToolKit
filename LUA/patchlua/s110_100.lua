...
function S110_100:Event_010()
  ...
  if Qst.Main:IsCompleted(M300.ID) and not Flg.Check(self.Flg01) then
    ...
    HideMinimap(true)
    HideGuide(true)
    Cam.Inst:Set(10.504, -3.106, 58.46, 2.9988, -1.0095, 64.72, default, 0)
    Obj:new(PLAYER, ""):SetPos(4.36, -2.7, 64.3, true)
    Obj:new(PLAYER, ""):SetRotationY(30, 0)
    Obj:new(NPC, "npc_warp02"):Invisible()
    WaitFrame(15)
    ...
    Cam.Inst:Set(2.284, -3.65, 57.192, 6, -1.092, 66.11, default, 0)
    Field.ObjectLookAtTheObject(NPC, vmon_index, PLAYER, 1, 0)
    Field.ObjectLookAtTheObject(PLAYER, 1, NPC, vmon_index, 0)
    WaitFrame(25)
    FadeAllInWithWait(FADE_BLACK, FADE_TIME)
    WaitFrame(30)
    ...
    elseif result == RESULT_TALK02 then
      ...
      WaitFrame(30)
      tlk:EndTalk()
      Field.ObjectCancelInvisible(NPC, GetIndex(NPC, "npc_warp02"), 0, 15, false, false)
      HideMinimap(false)
      HideGuide(false)
      goto lbl_681
    end
...
function S110_100:Event_020()
  if Qst.Sub:Check(self.ID, self.STEP_005, self.STEP_010) then
    ...
    Cam.Inst:Set(-7.499, -0.651, -16.755, -17.27, 1.46, -16.64, default, 0)
    FadeAllInWithWait(FADE_BLACK, FADE_TIME)
    local tlk = Tlk:new(text_file, 1, true)
    tlk:StartTalkAndCancelDigimonRide()
...
function S110_100:Event_030()
  if Qst.Sub:Check(self.ID, self.STEP_010, self.STEP_015) then
    ...
    Field.ObjectResetAim(PLAYER, 1, 20)
    Obj:new(NPC, "npc_warp02"):CancelInvisible()
    WaitFrame(15)
    Cam.Inst:Clear(0)
    FadeAllInWithWait(FADE_BLACK, FADE_TIME)
    tlk:EndTalk()

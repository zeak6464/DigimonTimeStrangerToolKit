...
function m120_030()
  ...
  if gender == HERO then
    local slot_01 = Event_PlaySE(412030, 100, false, 0, 0)
  elseif gender == HEROINE then
    local slot_01 = Event_PlaySE(411030, 100, false, 0, 0)
  end
  ...
  Field_InvisibleNpc("zudo_01", INVISIBLE_KEY_EVENT, 0, false)
  ...
  local gender = GetGender()
  if gender == HERO then
    local slot_01 = Event_PlaySE(412031, 100, false, 0, 0)
  elseif gender == HEROINE then
    local slot_01 = Event_PlaySE(411031, 100, false, 0, 0)
  end
  CAM_WAIT(0)
  CUT("3.0")
  SetEnv_All("c3.0", 0)
  ...
  local gender = GetGender()
  if gender == HERO then
    local slot_01 = Event_PlaySE(412032, 100, false, 0, 0)
  elseif gender == HEROINE then
    local slot_01 = Event_PlaySE(411032, 100, false, 0, 0)
  end
  PlayCamera("Camera04")
  WaitFrame(10)
  Vista.SetMessageTalkAuto("m120_030_010", -1, true, 0)
  WaitFrame(49)
  local slot_02 = Event_PlaySE(403118, 100, false, 0, 0)
  CAM_WAIT(0)
  CUT("5.0")
  SetEnv_All("c5.0", 0)
  PlayCamera("Camera05")
  ...
  local gender = GetGender()
  if gender == HERO then
    local slot_01 = Event_PlaySE(412033, 100, false, 0, 0)
  elseif gender == HEROINE then
    local slot_01 = Event_PlaySE(411033, 100, false, 0, 0)
  end
  PlayCamera("Camera07")
  ...
  local gender = GetGender()
  if gender == HERO then
    local slot_01 = Event_PlaySE(412034, 100, false, 0, 0)
  elseif gender == HEROINE then
    local slot_01 = Event_PlaySE(411034, 100, false, 0, 0)
  end
  ...
  MESSAGE_WAIT2()
  WaitFrame(210)
  local slot_02 = Event_PlaySE(403119, 100, false, 0, 0)

...
function BtlPlayDissolve(entry_id, is_force_idle_anime)
  if is_force_idle_anime == nil then
    is_force_idle_anime = true
  end
  Battle.PlayDissolve(entry_id, is_force_idle_anime)
end

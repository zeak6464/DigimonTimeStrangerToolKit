...
function Battle_Turn_Start(info)
  ...
  if Flg.Check("Battle5104") and Flg.Check("Battle5108") == false then
    ...
    Flg.Set("Battle5108")
  elseif Flg.Check("Battle5122") then
    Battle.AddMotionScheduleIdleByStatus(ENEMY_DIGIMON, 0, true)
    Talk.OpenLetterBox()
    Battle.CloseUI()
    Battle.SetCamera(7.48, 3.75, -3.03, 4.77, 3.5, -12.66, DEFAULT_ANGLE, 0, MODE_QUADRATIC_IN_OUT)
    Battle.MessageTalk(1090010011)
    WaitMessage()
    Battle.MessageTalk(1090010012)
    WaitMessage()
    Talk.CloseLetterBox()
  ...
  if Flg.Check("Battle5106") and Flg.Check("Battle5109") == false then
    Battle.AddMotionScheduleIdleByStatus(ENEMY_DIGIMON, 0, true)
    Talk.OpenLetterBox()
    Battle.CloseUI()
    Battle.SetCamera(7.48, 3.75, -3.03, 4.77, 3.5, -12.66, DEFAULT_ANGLE, 0, MODE_QUADRATIC_IN_OUT)
...
function Battle_Turn_End(info)
  ...
  elseif Flg.Check("Battle5104") then
    ...
    elseif is_resist == true and Flg.Check("Battle5112") == false then
      print("##### Big Failed #####")
      Talk.OpenLetterBox()
      Battle.CloseUI()
      ...
      BtlSetInterruptCharacter(ENEMY_DIGIMON, 0, BATTLE_INTERRUPT_TYPE_ACT_NO_COUNT)
      Flg.Set("Battle5112")
    elseif CP_Round == 3 and Flg.Check("Battle5111") == false then
      print("##### Failed #####")
      Talk.OpenLetterBox()
      Battle.CloseUI()
      Battle.SetCamera(8.12, 5.82, -0.61, 3.38, 6.31, -9.4, DEFAULT_ANGLE, 30, MODE_QUADRATIC_IN_OUT)
  ...
  if enemy_last_skill_id == 29091 then
  ...
  if enemy_last_skill_id == 29097 then
    if Flg.Check("Battle5107") == false then
      Talk.OpenLetterBox()
      Battle.CloseUI()
      Battle.SetCamera(-0.61, 4.37, -0.34, -1.23, 4.44, -10.32, DEFAULT_ANGLE, 60, MODE_QUADRATIC_IN_OUT)
      Battle.SetModelPosition(GUEST_AEGIOMON, 0, 31.71, 0, 8.6)
    ...
    if Flg.Check("Battle5120") then
      Battle.RemoveBuff(GUEST_DIGIMON, 0, 114100)
  ...
  if Flg.Check("Battle5051") == false and Flg.Check("Battle5111") == false and Flg.Check("Battle5112") == false then
    ...
    local random = math.random(1, 100)
    if is_break then
      Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 29097)
    elseif Flg.Check("Battle5106") then

...
function Start()
  ...
  for i = 1, GetInstanceCount() do
    ...
    SetInstanceScale(i, math.random(30, 80) * 0.01, math.random(30, 80) * 0.01, math.random(30, 80) * 0.01)
  end
end
...
function Update()
  ...
  for i = 1, GetInstanceCount() do
    ...
    SetInstancePosition(i, tx * ratio_tx1[i] + cpx[i], ty * ratio_ty1[i] + cpy[i], tz * ratio_tz1[i] + cpz[i])

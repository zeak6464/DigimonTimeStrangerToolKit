...
function m320_024()
  ...
  LoadEnvironmentFile("c1.0", "es_m320_024_c1.0")
  WaitVistaLoad()
  ...
  SetCamera(4.083, 5.011, 18.694, 0, 30, "LINEAR", 0, false, 0)
  SetCameraTarget(-0.662, 12.43, -3.205, "LINEAR", 0, false, 0)
  SetCamera(-3.646, 4.595, 27.364, -5, 30, "ACCEL", 180, false, 0)
  SetCameraTarget(-0.02, 10.22, -0.031, "ACCEL", 180, false, 0)
  CameraOffsetTurn(-20, "DECEL", false, true, 600, 175)
  FIELD_SET()
  EVENT_START()
  CUT("1.0")
  SetEnv_All("c1.0", 0)

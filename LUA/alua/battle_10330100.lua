...
function Battle_Round_Start(info)
  ...
  if Flg.Check("Battle5105") and Flg.Check("Battle5102") == false then
    Talk.OpenLetterBox()
    Battle.CloseUI()
...
function Battle_Turn_End(info)
  ...
  if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_WAKE_DAMAGE_VALUE_OVER, 3, ENEMY_DIGIMON, 0, 2000) then
    Flg.Set("Battle5015")
  end
  if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_DAMAGE_VALUE_OVER, 4, ENEMY_DIGIMON, 0, 3000) then
    Flg.Set("Battle5016")
  end

...
function Battle_Turn_End(info)
  ...
  if Battle.IsAccomplishConditionType2(BATTLE_CONDITION_TYPE_DAMAGE_MAGNIFICATION_BELOW, 3, ENEMY_DIGIMON, 0, 6, 200, false) then
    Flg.Set("Battle5015")
  end
...
function Battle_Ending(info)
  Common.SetDigimonGraspState(416, DIGIMON_GRASP_FLAG_SCAN)
end

...
function Battle_Turn_End(info)
  ...
  if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_REFLECT_PHYSICAL, 0, ENEMY_DIGIMON, 0, 1) then
    Flg.Set("Battle5015")
  end
  if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_COUNTER_MAGIC, 0, ENEMY_DIGIMON, 0, 1) then
    Flg.Set("Battle5016")
  end

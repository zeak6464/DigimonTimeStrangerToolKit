...
function LoadRequest()
  ...
  if gMapNum == 201 then
    ...
    Mob(knightmon).LoadMoveMotion("symbol01")
    Mob(syautomon).LoadMoveMotion("symbol01")
    Mob(toyagumon).LoadMoveMotion("symbol01")
    local pandamon = GetIndex(MOB, "m350_0003")
    local starmon = GetIndex(MOB, "m350_0004")
    Mob(pandamon).LoadMoveMotion("symbol01")
    Mob(starmon).LoadMoveMotion("symbol01")
    local fanbimon = GetIndex(NPC, "npc_773")
    local raramon = GetIndex(NPC, "npc_774")
    Npc(fanbimon).LoadMoveMotion("mob01")
    Npc(raramon).LoadMoveMotion("symbol01")
  elseif gMapNum == 202 then
    local lunamon = GetIndex(NPC, "npc_0013")
    Npc(lunamon).LoadMotion("bn01")
    Npc(lunamon).LoadMotion("br01")
    Npc(lunamon).LoadMotion("e004")
    Npc(lunamon).LoadMotion("e008")
    local knightmon = GetIndex(MOB, "m350_0001")
    local syautomon = GetIndex(MOB, "m350_0002")
    Mob(knightmon).LoadMoveMotion("symbol01")
    Mob(syautomon).LoadMoveMotion("symbol01")
    ...
    Mob(toyagmon).LoadMoveMotion("symbol01")
  ...
  if gMapNum == 217 then
    CtrlLoadNPCMotion("npc_0120", "br01", "bn01")
  end
end

...
function m260_040()
  ...
  SetEnv_All("c1.0", 0)
  SetCamera(4.56, 83.742, -7.941, 0, 38, "LINEAR", 0, false, 0)
  SetCameraTarget(2.985, 85.359, -18.289, "LINEAR", 0, false, 0)
  ...
  SetCamera(2.145, 81.041, -7.926, 0, 38, "LINEAR", 180, true, 0, false)
  SetCameraTarget(-0.168, 82.577, -18.147, "LINEAR", 180, true, 0, false)
  SetMobTransparentRange(2000, 500, 2000)
  Fade_In(0, 30)
  WaitFrame(150)
  Event_Quake_Start(0.5, 0.5, 10, 10)
  Event_Quake_Start(0.5, 0, 30, 20)
  WaitFrame(50)
  ...
  WaitFrame(90)
  Event_PlaySE(500006, 100, true, 0, 0)
  MOVE_WAIT("HERO_01")
  CAM_POS_WAIT(0)
  CUT("3.0")
  SetEnv_All("c3.0", 0)

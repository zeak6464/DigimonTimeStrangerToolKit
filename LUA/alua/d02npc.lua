...
function OnCheckNPC(npc)
  ...
  if gMapNum == 201 then
    ...
    elseif talk_id == 454 then
      ...
      CommonShopStart(npc_name, 103, "bv01", "fe04", "fe02", cam_npc, cam_shop, "f000", "fe02")
  ...
  elseif gMapNum == 203 then
    ...
    if talk_id == 500 then
      ...
      Field.ObjectLookAtTheObject(PLAYER, 1, NPC, npc_index, 15)
  ...
  if gMapNum == 217 then
    if talk_id == 300 then
      ...
      if Flg.Check("FLAG_MAIN_22_020") then

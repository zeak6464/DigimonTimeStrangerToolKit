...
function S080_060:Event_070()
  if Qst.Sub:Check(self.ID, self.STEP_010) then
    ...
    if result == RESULT_TALK01 then
      ...
      tlk:EndTalk(true)
      EncountFromField_PlaySound(20800600, 10272, false)
    end
...
function S080_060:Event_080()
  if Qst.Sub:Check(self.ID, self.STEP_010) then
    ...
    if result == RESULT_TALK01 then
      ...
      tlk:EndTalk(true)
      EncountFromField_PlaySound(20800601, 10272, false)
    end
  end
end
...
function S080_060:Event_090()
  if Qst.Sub:Check(self.ID, self.STEP_010) then
    EncountFromField_PlaySound(20800602, 10272, false)
  end
end

function S080_060:Event_100()
  if Qst.Sub:Check(self.ID, self.STEP_010) then
    EncountFromField_PlaySound(20800603, 10272, false)
  end
end
...
function S080_060:Event_110()
  ...
  if Qst.Sub:Check(self.ID, self.STEP_010) then
    ...
    if result == RESULT_TALK01 then
      ...
      tlk:EndTalk(true)
      EncountFromField_PlaySound(20800604, 10272, false)
    end
  end
end

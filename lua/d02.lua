...
function ProcessIfNeedByStartLocator(start_loc)
  ...
  if gMapNum == 217 and start_loc == "start_00" and not Flg.Check("FLAG_MAIN_03_560") then
    Flg.Set("FLAG_SKIP_AREACHANGE_MOVE")
  end
...
function StartEventBeforeFadeIn()
  ...
  if gMapNum == 203 and Flg.Check("FLAG_MAIN_ASSISTANT_3") then
  ...
  if gMapNum == 216 and not Flg.Check("FLAG_MAIN_03_470") then
...
function StartEventAfterFadeIn()
  ...
  elseif gMapNum == 217 then
    M120:Event_Playable_DigeAttackTutorial()
  end
end

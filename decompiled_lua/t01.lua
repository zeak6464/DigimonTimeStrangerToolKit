...
function StartEventAfterFadeIn()
  ...
  if gMapNum == 101 and Common.CheckTimeAxis("A2028_daft_419") then
    require("Sow_202")
    SeekDrKuga_T0101()
  end
  if gMapNum == 102 then
  ...
  if gMapNum == 104 and Common.CheckTimeAxis("A2028_daft_419") then
    require("Sow_202")
    SeekDrKuga_T0104()
  end
  if gMapNum == 105 then
  ...
  if gMapNum == 107 and Common.CheckTimeAxis("A2028_daft_419") then
    require("Sow_202")
    SeekDrKuga_T0107()
  end
  if gMapNum == 108 and Common.CheckTimeAxis("A2028_daft_419") then
    require("Sow_202")
    SeekDrKuga_T0108()
  end
  if gMapNum == 109 then
  ...
  if gMapNum == 110 and Common.CheckTimeAxis("A2028_daft_419") then
    require("Sow_202")
    SeekDrKuga_T0110()
  end
  if gMapNum == 111 and Common.CheckTimeAxis("A2028_daft_419") then
    require("Sow_202")
    SeekDrKuga_T0111()
  end
end

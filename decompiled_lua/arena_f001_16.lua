...
function arena_f001_16()
  ...
  LoadModel("enemy_01", "char_TERRIERMON")
  LoadModel("enemy_02", "char_KERPYMON_GOOD")
  LoadModel("enemy_03", "char_LOPMON")
  ...
  WaitFrame(30)
  MessageTalk("arena01_f001_016_010")
  MessageClose()
  WaitFrame(10)
  CUT("2.0")
  SetEnv_All("c3.0", 0)
  ...
  WaitFrame(10)
  MessageTalk("arena01_f001_016_020")
  MessageClose()
  WaitFrame(10)
  CUT("3.0")
  SetEnv_All("c2.0", 0)
  ...
  SetPosition("enemy_01", -6.518, 0, -1.39, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 90, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -9.795, 0, 0.529, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 101.5, 0, "LINEAR", 0, 0)
  SetPosition("enemy_03", -5.808, 0, 2.686, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 105, 0, "LINEAR", 0, 0)
  SetCamera(-16.375, 1.01, -8.851, 0, 25, "LINEAR", 0, false, 0, false)
  SetCameraTarget(-6.701, 2.035, 0.507, "LINEAR", 0, false, 0, false)
  SetCamera(-4.505, 1.01, -10.591, 0, 25, "SCURVE", 60, false, 0, false)
  SetCameraTarget(-7.771, 2.035, 0.507, "SCURVE", 60, false, 0, false)
  SetCamera(-1.265, 1.01, -10.891, 0, 25, "LINEAR", 150, true, 60, false)
  SetCameraTarget(-7.821, 2.035, 0.507, "LINEAR", 150, true, 60, false)
  WaitFrame(10)
  MessageTalk("arena01_f001_016_030")
  MessageClose()
  WaitFrame(10)
  CUT("4.0")
  SetEnv_All("c2.0", 0)
  ...
  ModelVisible("enemy_02", true, 0, 0)
  ModelVisible("enemy_03", true, 0, 0)
  SetPosition("enemy_01", -7.518, 0, -1.39, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 90, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -9.795, 0, 0.529, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 101.5, 0, "LINEAR", 0, 0)
  SetPosition("enemy_03", -6.808, 0, 2.086, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 105, 0, "LINEAR", 0, 0)
  SetCamera(-1.804, 0.705, -0.517, 0, 45, "LINEAR", 0, true, 0, false)
  SetCameraTarget(-11.596, 2.249, 0.796, "LINEAR", 0, true, 0, false)
  WaitFrame(10)
  PlayMotion("enemy_03", "fe04", 10, false, 0)
  PlayMotion("enemy_03", "bn01", 10, true, 60)
  WaitFrame(10)
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_016_040")
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  PlayMotion("enemy_01", "fe03", 10, false, 0)
  PlayMotion("enemy_01", "bn01", 10, true, 90)
  WaitFrame(10)
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_016_041")
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  ...
  WaitFrame(10)
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_016_042")
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(20)
  CUT("5.0")
  ...
  SetPosition("enemy_01", -4.519, 0, -2.5, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 92.5, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -6.685, 0, 0, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 92.5, 0, "LINEAR", 0, 0)
  SetPosition("enemy_03", -3.809, 0, 2.5, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 102, 0, "LINEAR", 0, 0)
  BlendEye("HEROINE_01", 0, 0, "SCURVE", 0, 0)
  BlendFace("HEROINE_01", -38, 0, 0, false, "SCURVE", 0, 0)
  SetCamera(-0, 4.747, 6.565, 0, 20, "LINEAR", 0, false, 0, false)
  SetCameraTarget(0, 10.052, 37.683, "LINEAR", 0, false, 0, false)
  SetCamera(-0, 1.647, -22.412, 0, 33, "DECEL", 10, false, 0, false)
  SetCameraTarget(0, 4.308, 0, "DECEL", 10, false, 0, false)
  SetCamera(-0, 1.35, -24.91, 0, 33, "LINEAR", 150, true, 10, false)
  SetCameraTarget(0, 4.308, 0, "LINEAR", 150, true, 10, false)
  MessageTalk("arena01_f001_016_050")
  MessageClose()
  WaitFrame(30)

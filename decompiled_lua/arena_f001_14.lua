...
function arena_f001_14()
  ...
  LoadModel("enemy_01", "char_TYILINMON")
  LoadModel("enemy_02", "char_GODDRAMON")
  ...
  WaitFrame(30)
  MessageTalk("arena01_f001_014_010")
  MessageClose()
  WaitFrame(10)
  CUT("2.0")
  SetEnv_All("c3.0", 0)
  ...
  WaitFrame(10)
  MessageTalk("arena01_f001_014_020")
  MessageClose()
  WaitFrame(10)
  CUT("3.0")
  SetEnv_All("c2.0", 0)
  ...
  SetRotation("enemy_01", 0, 90, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -6.295, 0, 1.529, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 101.5, 0, "LINEAR", 0, 0)
  SetCamera(-16.375, 1.51, -8.851, 0, 18, "LINEAR", 0, false, 0, false)
  SetCameraTarget(-6.701, 3.035, 0.507, "LINEAR", 0, false, 0, false)
  SetCamera(-4.505, 1.51, -10.591, 0, 18, "SCURVE", 60, false, 0, false)
  SetCameraTarget(-7.771, 3.035, 0.507, "SCURVE", 60, false, 0, false)
  SetCamera(-1.265, 1.51, -10.891, 0, 18, "LINEAR", 150, true, 60, false)
  SetCameraTarget(-7.821, 3.035, 0.507, "LINEAR", 150, true, 60, false)
  WaitFrame(10)
  MessageTalk("arena01_f001_014_030")
  MessageClose()
  WaitFrame(10)
  CUT("4.0")
  SetEnv_All("c2.0", 0)
  ModelVisible("enemy_01", true, 0, 0)
  ModelVisible("enemy_02", true, 0, 0)
  SetPosition("enemy_01", -6.84, 0, -1.357, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 0, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -6.84, 0, 2.3, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 180, 0, "LINEAR", 0, 0)
  SetCamera(-0.652, 3.684, 1.297, 0, 45, "LINEAR", 0, true, 0, false)
  SetCameraTarget(-10.452, 2.15, 0.03, "LINEAR", 0, true, 0, false)
  WaitFrame(10)
  PlayMotion("enemy_01", "fe02", 10, false, 0)
  PlayMotion("enemy_01", "bn01", 10, true, 55)
  WaitFrame(10)
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_014_040")
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  ...
  WaitFrame(10)
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_014_041")
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  PlayMotion("enemy_01", "fe02", 10, false, 0)
  ...
  WaitFrame(10)
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_014_042")
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(20)
  CUT("5.0")
  ...
  MessageTalk("arena01_f001_014_050")
  MessageClose()
  WaitFrame(30)

...
function arena_f001_02()
  ...
  LoadModel("enemy_01", "char_TENTOMON")
  LoadModel("enemy_02", "char_SNIMON")
  LoadModel("enemy_03", "char_FUNBEEMON")
  ...
  WaitFrame(30)
  MessageTalk("arena01_f001_002_010")
  MessageClose()
  WaitFrame(10)
  CUT("2.0")
  SetEnv_All("c3.0", 0)
  ...
  WaitFrame(10)
  MessageTalk("arena01_f001_002_020")
  MessageClose()
  WaitFrame(10)
  CUT("3.0")
  SetEnv_All("c2.0", 0)
  ...
  SetPosition("enemy_01", -9.018, 1.3, -1.39, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 90, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -6.295, 0, 0.529, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 101.5, 0, "LINEAR", 0, 0)
  SetPosition("enemy_03", -8.308, 1, 2.686, "LINEAR", 0, 0)
  ...
  WaitFrame(10)
  MessageTalk("arena01_f001_002_030")
  MessageClose()
  WaitFrame(10)
  CUT("4.0")
  SetEnv_All("c2.0", 0)
  ...
  SetPosition("enemy_03", -8.308, 1, 2.686, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 105, 0, "LINEAR", 0, 0)
  SetCamera(-2.89, 1.91, 0.28, 0, 45, "LINEAR", 0, true, 0, false)
  SetCameraTarget(-12.8, 1.32, 0.81, "LINEAR", 0, true, 0, false)
  WaitFrame(10)
  PlayMotion("enemy_01", "fe02", 10, false, 0)
  PlayMotion("enemy_01", "bn01", 10, true, 110)
  WaitFrame(10)
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_002_040")
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  SetRotation("enemy_03", 0, 180, 0, "LINEAR", 15, 0)
  WaitFrame(15)
  PlayMotion("enemy_03", "fe04", 10, false, 0)
  PlayMotion("enemy_03", "bn01", 10, true, 80)
  WaitFrame(10)
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_002_041")
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  SetRotation("enemy_01", 0, 0, 0, "LINEAR", 15, 0)
  WaitFrame(15)
  PlayMotion("enemy_01", "fe03", 10, false, 0)
  PlayMotion("enemy_01", "bn01", 10, true, 90)
  WaitFrame(10)
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_002_042")
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  PlayMotion("enemy_02", "fq02", 10, false, 0)
  PlayMotion("enemy_02", "bn01", 10, true, 50)
  WaitFrame(10)
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_f001_002_043")
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  SetRotation("enemy_01", 0, 90, 0, "LINEAR", 15, 0)
  SetRotation("enemy_03", 0, 90, 0, "LINEAR", 15, 0)
  MessageClose()
  WaitFrame(20)
  CUT("5.0")
  SetEnv_All("c4.0", 0)
  ...
  SetPosition("enemy_01", -7.019, 1, -2.5, "LINEAR", 0, 0)
  ...
  SetPosition("enemy_03", -5.809, 1, 2.5, "LINEAR", 0, 0)
  ...
  MessageTalk("arena01_f001_002_050")
  MessageClose()
  WaitFrame(30)

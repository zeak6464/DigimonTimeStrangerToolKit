...
function Battle_Turn_Start(info)
  ...
  if round_count == 1 and enemy_id == 87701 and Flg.Check("Battle5007") == false then
    Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 30072)
...
function Battle_Command_Start(info)
  ...
  if info.enemy_id == 87701 then
    ...
    if round_count % 5 == 0 and Flg.Check("Battle5006") == false then
...
function Battle_Turn_End(info)
  ...
  if stock_num == 0 or 2 <= stock_num then

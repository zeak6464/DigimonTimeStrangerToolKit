...
function Battle_Turn_Start(info)
  ...
  if Flg.Check("FLAG_MAIN_03_690") and Flg.Check("Battle5104") == false then
    Battle.SetNextCommandSkill(GUEST_DIGIMON, 1, 20803)
...
function Battle_Command_Start(info)
  ...
  if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_WAKE_DAMAGE_VALUE_OVER, 3, ENEMY_DIGIMON, 0, 2300) then
    Flg.Set("Battle5015")
  end
  if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_DAMAGE_VALUE_OVER, 4, ENEMY_DIGIMON, 0, 2800) then
    Flg.Set("Battle5016")
  end
  ...
  if enemy_id == 92601 then
    ...
    if enemy_last_skill_id == 29268 and Flg.Check("Battle5053") == false then
...
function Battle_Turn_End(info)
  ...
  if enemy_id == 92601 and Flg.Check("Battle5053") == false and Flg.Check("Battle5118") == false then
    local target_list = {}
    for idx = 0, 2 do
  ...
  if Flg.Check("FLAG_MAIN_03_690") == false and enemy_now_hp / enemy_max_hp <= 0.65 and (enemy_last_skill_id == 29268 or enemy_now_hp == 1 or enemy_now_hp / enemy_max_hp <= 0.3 and Flg.Check("Battle5053") == false) then
  ...
  if Flg.Check("Battle5052") == false then
    ...
    elseif stock_num == 2 then
      Battle.SetExtraTurn(ENEMY_DIGIMON, 0, true)
      Battle.SetExtraTurnNextCommandSkill(ENEMY_DIGIMON, 0, 30201)

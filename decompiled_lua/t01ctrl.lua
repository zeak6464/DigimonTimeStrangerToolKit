...
function PreparationBeforeReactionToField(elapsed_frame)
  ...
  elseif gMapNum == 103 then
    if CheckTimeAxis("A2028_daft_310", "A2028_daft_10000") or CheckTimeAxis("P2028_daft_310", "P2028_daft_10000") then
    else
      DisableLinkCollisionInNowFrame("col_t0121_start_00_0")
    end
  elseif gMapNum == 108 then
    if CheckTimeAxis("X2028_daft_0", "X2028_daft_20") or CheckTimeAxis("P2028_daft_0", "P2028_daft_10000") or CheckTimeAxis("A2028_daft_310", "A2028_daft_10000") then

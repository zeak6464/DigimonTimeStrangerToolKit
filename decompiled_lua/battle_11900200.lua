...
function Battle_Before_Setup()
  ...
  if random == 1 then
    Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 1, 87101, 53)
  elseif random == 2 then
    Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 1, 87201, 53)
  end
  random = math.random(1, 2)
  if random == 1 then
    Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 2, 87101, 53)
  elseif random == 2 then
    Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 2, 87201, 53)
  end

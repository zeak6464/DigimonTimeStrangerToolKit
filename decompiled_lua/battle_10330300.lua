...
function Battle_Turn_End(info)
  ...
  if enemy_id == 95401 and Battle.GetCharacterLastCommandSkillID(ENEMY_DIGIMON, 0) == 24403 then
  ...
  if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_DAMAGE_VALUE_OVER, 7, ENEMY_DIGIMON, 0, 3800) then
    Flg.Set("Battle5012")
  end
end

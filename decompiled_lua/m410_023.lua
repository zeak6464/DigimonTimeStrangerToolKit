...
function m410_023()
  ...
  PlayMotion("chr580_01", "f003", 5, false, 40)
  PlayMotion("chr580_01", "bn01", 3, true, 186)
  SetFace("chr580_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  PlayMotion("chr579_01", "fq01", 5, false, 50)
  PlayMotion("chr579_01", "bn01", 3, true, 92)
  SetFace("chr579_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  PlayMotion("chr824_01", "e004", 5, true, 50)
  SetFace("chr824_01", "F01", 0, 1, FACE_BLENDTIME, 0)
  PlayMotion("chr931_01", "e004", 5, true, 30)
  SetFace("chr931_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  PlayMotion("chr601_01", "fq01", 5, false, 20)
  PlayMotion("chr601_01", "bn01", 3, true, 70)
  SetFace("chr601_01", "F01", 0, 1, FACE_BLENDTIME, 0)

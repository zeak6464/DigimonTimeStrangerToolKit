  ...
  elseif gMapNum == 303 then
    ...
    elseif col_name == "evt_9007" then
      ...
      elseif not Flg.Check("FLAG_FIELD_D0303_020") then
        ...
        if Flg.Check("FLAG_MAIN_05_100") then
        elseif not Flg.Check("FLAG_FIELD_D0303_RAIDTALK03_FIRST") then
          Field_Talk_Start("d03", 1)
          Message("f_d0303_0010_0010")
          Field_Talk_End()
          Flg.Set("FLAG_FIELD_D0303_RAIDTALK03_FIRST")
        end
      end
    ...
    if gim_tag == "WaterFlow_Ride" then
      if Flg.Check("FLAG_MAIN_05_100") then
        ...
        if Flg.Check("FLAG_MAIN_05_130") then
          if not Flg.Check("FLAG_FIELD_D0303_RAIDTALK01_FIRST") then
            Message("f_d0303_0090_0010")
            Flg.Set("FLAG_FIELD_D0303_RAIDTALK01_FIRST")
          end
        elseif not Flg.Check("FLAG_FIELD_D0303_RAIDTALK02_FIRST") then
          Talk.NextNoVoice()
          Message("f_d0303_0020_0010")
          Flg.Set("FLAG_FIELD_D0303_RAIDTALK02_FIRST")
        end
        Field_Talk_End()

...
function M010:Event_090()
  if Qst.Main:Check(self.ID, self.STEP_016, self.STEP_017) and Flg.Check("FLAG_MAIN_01_070", "FLAG_MAIN_01_080") then
...
function M010:Event_093()
  if Qst.Main:Check(self.ID, self.STEP_017, self.STEP_018) and Flg.Check("FLAG_MAIN_01_070", "FLAG_MAIN_01_080") then
    Flg.Set("FLAG_MAIN_01_080")
    Field.CancelDisableSystemFieldAttack()
    Field.CancelDisableAnalyzeAndFieldAttack()
    SystemFlag.ClearFieldKeyHelpForNewGame()

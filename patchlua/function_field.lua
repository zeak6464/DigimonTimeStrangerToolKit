...
function Tlk:new(file_name, mode, is_open_letter, is_not_invisible)
  ...
  function obj:Narration(message, position, align, layout, dark_change)
    ...
    align = align or 0
    layout = layout or 0
    if dark_change == nil and not dark_change then
      dark_change = true
    end
...
function Qst.Sub:End(quest_id, flag_id, is_save)
  ...
  if not Flg.Check("FLAG_IS_CLEAR_S100_178") then
    ...
    if Flg.Check("FLAG_MAIN_03_460", "FLAG_MAIN_07_010") then
      if Qst.Sub:IsCompleted(90) then
        print("table 1111111111111111111111111111111111111111111111")
        sub_table = {
          18,
          172,
          24,
        ...
        print("table 222222222222222222222222222222222222222222")
        sub_table = {
          18,
          172,
          24,
  ...
  if count_notclear == 0 then
    if digitter_id == 1 then
      ...
      Flg.Set("FLAG_IS_CLEAR_SUB_001")
    elseif digitter_id == 2 then
      Digitter.Send(2500020)
      Flg.Set("FLAG_IS_CLEAR_SUB_002")
...
function Qst.DLC:Clear(quest_id, flag_id)
  Quest.ClearFlag(quest_id, flag_id)
end
...
function MapNameDisp()
  if not Flg.Check("FLAG_IS_DISPLAYED_MAP_NAME_UI") then
    ...
    if map_prefix == "t" then
      ...
      elseif map_num == 111 then
        OpenIntroduction(10111, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 121 then
        OpenIntroduction(10121, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 201 then
        OpenIntroduction(10201, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 203 then
        OpenIntroduction(10203, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 303 then
        OpenIntroduction(10303, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 304 then
        OpenIntroduction(10304, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 3004 then
        OpenIntroduction(13004, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      end
    end
    if map_prefix == "d" then
      ...
      elseif map_num == 103 then
        OpenIntroduction(20103, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 104 then
        OpenIntroduction(20104, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 105 then
        OpenIntroduction(20105, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 106 then
        OpenIntroduction(20106, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 107 then
        OpenIntroduction(20107, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 108 then
        OpenIntroduction(20108, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 109 then
        OpenIntroduction(20109, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 201 then
      ...
      elseif map_num == 207 then
        OpenIntroduction(20207, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 208 then
        OpenIntroduction(20208, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 209 then
        OpenIntroduction(20209, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 210 then
        OpenIntroduction(20210, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 302 then
        OpenIntroduction(20302, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 303 then
        OpenIntroduction(20303, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 304 then
        OpenIntroduction(20304, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 305 then
        OpenIntroduction(20305, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 402 then
        OpenIntroduction(20402, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 403 then
        OpenIntroduction(20403, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 404 then
        OpenIntroduction(20404, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 405 then
        OpenIntroduction(20405, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 406 then
        OpenIntroduction(20406, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 502 then
        OpenIntroduction(20502, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 550 then
        OpenIntroduction(20550, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 551 then
        OpenIntroduction(20551, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 552 then
        OpenIntroduction(20552, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 601 then
        OpenIntroduction(20601, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 602 then
        OpenIntroduction(20602, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 603 then
        OpenIntroduction(20603, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 604 then
        OpenIntroduction(20604, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 605 then
        OpenIntroduction(20605, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 606 then
        OpenIntroduction(20606, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 609 then
        OpenIntroduction(20609, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 703 then
        OpenIntroduction(20703, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 801 then
        OpenIntroduction(20801, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 802 then
        OpenIntroduction(20802, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 900 then
        OpenIntroduction(20900, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 901 then
        OpenIntroduction(20901, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 902 then
        OpenIntroduction(20902, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 903 then
        OpenIntroduction(20903, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 904 then
        OpenIntroduction(20904, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 905 then
        OpenIntroduction(20905, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 906 then
        OpenIntroduction(20906, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 907 then
        OpenIntroduction(20907, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 1001 then
        OpenIntroduction(21001, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 1104 then
        OpenIntroduction(21104, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      ...
      elseif map_num == 1205 then
        OpenIntroduction(21205, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 1206 then
        OpenIntroduction(21206, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 1301 then
        OpenIntroduction(21301, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 1302 then
        OpenIntroduction(21302, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 1303 then
        OpenIntroduction(21303, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
      elseif map_num == 1304 then
        OpenIntroduction(21304, MAP_NAME_DISPLAY_DELAY_FLAME, MAP_NAME_DISPLAY_FLAME)
...
function EncountFromField_WithNormalEffect(encount_id, battle_map_id, with_effect)
  Sound.PlaySE(300018, 100)
  StartEncountEffectNormal()
  WaitFrame(1)
  Battle.Encount(encount_id, battle_map_id, false)
...
function Obj:new(object_type, unique_name, follower)
  ...
  function obj:SetPos(x, y, z, on_ground)
    if on_ground == nil and not on_ground then
      on_ground = true
    end
...
function ResetFAObject(with_item)
  if with_item == nil and not with_item then
    with_item = true
  end
  local index = 0

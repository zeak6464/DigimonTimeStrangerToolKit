...
function arena_m320_02()
  ...
  LoadModel("enemy_01", "char_TONOSAMAGEKOMON")
  LoadModel("enemy_02", "char_PIEDMON")
  LoadModel("enemy_03", "char_SKULLMAMMON")
  ...
  SetCameraTarget(9.201, 12.193, 0.471, "LINEAR", 0, false, 0, false)
  SetCamera(-19.382, 3.118, 24.855, -10, 30, "SCURVE", 180, true, 0, false)
  SetCameraTarget(4.609, 12.23, -4.998, "SCURVE", 180, true, 0, false)
  SetCamera(-15.081, 0.385, 33.732, -10, 30, "DECEL", 200, true, 175, false)
  SetCameraTarget(3.231, 12.421, -6.639, "DECEL", 200, true, 175, false)
  FIELD_SET()
  EVENT_START()
  CUT("1.0")
  SetEnv_All("c1.0", 0)
  ...
  MessageTalk("arena01_m320_020_010")
  MessageClose()
  WaitFrame(10)
  CUT("2.0")
  SetEnv_All("c3.0", 0)
  ...
  WaitFrame(10)
  MessageTalk("arena01_m320_020_020")
  MessageClose()
  WaitFrame(10)
  CUT("3.0")
  SetEnv_All("c2.0", 0)
  ...
  SetCamera(-16.375, 1.01, -8.851, 0, 18, "LINEAR", 0, false, 0, false)
  SetCameraTarget(-6.701, 2.535, 0.507, "LINEAR", 0, false, 0, false)
  SetCamera(-4.505, 1.01, -10.591, 0, 18, "SCURVE", 60, false, 0, false)
  SetCameraTarget(-7.771, 2.535, 0.507, "SCURVE", 60, false, 0, false)
  SetCamera(-1.265, 1.01, -10.891, 0, 18, "LINEAR", 150, true, 60, false)
  SetCameraTarget(-7.821, 2.535, 0.507, "LINEAR", 150, true, 60, false)
  WaitFrame(10)
  MessageTalk("arena01_m320_020_030")
  MessageClose()
  WaitFrame(10)
  CUT("4.0")
  SetEnv_All("c2.0", 0)
  ...
  SetPosition("enemy_02", -6.295, 0, 0.529, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 101.5, 0, "LINEAR", 0, 0)
  SetPosition("enemy_03", -9.308, 0, 2.686, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 105, 0, "LINEAR", 0, 0)
  SetCamera(-2.39, 2.21, 0.28, 0, 45, "LINEAR", 0, true, 0, false)
  SetCameraTarget(-12.3, 1.62, 0.81, "LINEAR", 0, true, 0, false)
  WaitFrame(10)
  PlayMotion("enemy_02", "fq02", 10, true, 0)
  PlayMotion("enemy_02", "bn01", 10, true, 50)
  WaitFrame(10)
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_m320_020_040")
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  PlayMotion("enemy_01", "fe02", 10, false, 0)
  PlayMotion("enemy_01", "bn01", 10, true, 76)
  WaitFrame(10)
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_m320_020_041")
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  ...
  WaitFrame(10)
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_m320_020_042")
  SetFace("enemy_03", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(20)
  CUT("5.0")

...
function Battle_Turn_Start(info)
  local enemy_id = info.enemy_id
  local round_count = info.round
  if 3 <= round_count and 3 <= Flgcount() and Flg.Check("Battle5105") == false then
    Flg.Set("Battle5051")
  end
  if Flg.Check("Battle5053") then
  ...
  if Flg.Check("Battle5053") then
    ...
    Battle.SetNextCommandSkill(GUEST_DIGIMON, 1, 30113)
  end
  ...
  if (round_count == 2 or Battle.GetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_HP) == 1) and enemy_id == 95601 and Flg.Check("Battle5103") == false then
    Battle.CloseUI()
...
function Battle_Action_Start(info)
  ...
  if info.group == ENEMY_DIGIMON and info.enemy_id == 95601 then
    local skill_id = Battle.GetLastCommandSkillID()
    print("##### skill_id:", skill_id, " #####")
    if skill_id == 29561 and info.use_count == 0 then
...
function Battle_Turn_End(info)
  if Battle.GetCharacterLastCommandSkillID(ENEMY_DIGIMON, 0) == 29562 then
  ...
  local round_count = info.round
  if round_count == 4 and Flg.Check("Battle5101") == false then
    Flg.Set("Battle5011")
  end
  if Round == 4 and Flg.Check("Battle5101") then
    Flg.Set("Battle5012")
  end
  ...
  elseif stock_num == 1 then
    if Flg.Check("Battle5051") or round_count % 2 == 0 then

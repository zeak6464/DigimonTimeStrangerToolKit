...
function S110_211:Event_030()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    elseif result == RESULT_TALK01 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102110, 10276, false)
    else
...
function S110_211:Event_040()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102111, 10276, false)
    else
...
function S110_211:Event_050()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102112, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else
...
function S110_211:Event_060()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102113, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else
...
function S110_211:Event_070()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    elseif result == RESULT_TALK01 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102114, 10276, false)
    else
      if result == RESULT_TALK02 then
        tlk:EndTalk()
      else
...
function S110_211:Event_080()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102115, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else
...
function S110_211:Event_090()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    elseif result == RESULT_TALK01 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102116, 10276, false)
    else
      if result == RESULT_TALK02 then
        tlk:EndTalk()
      else
...
function S110_211:Event_100()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102117, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else
...
function S110_211:Event_110()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102118, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else
...
function S110_211:Event_120()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102119, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else
...
function S110_211:Event_130()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102120, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else
...
function S110_211:Event_140()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102121, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else
...
function S110_211:Event_150()
  ...
  if Qst.Sub:IsCompleted(self.ID) then
    ...
    if result == RESULT_TALK00 then
      ...
      tlk:EndTalk()
      EncountFromField_WithNormalEffect(21102122, 10276, false)
    else
      if result == RESULT_TALK01 then
        tlk:EndTalk()
      else

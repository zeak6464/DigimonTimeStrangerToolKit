...
function Battle_Command_Start(info)
  if Flg.Check("Battle5051") then
    Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 29211)
...
function Battle_Turn_End(info)
  ...
  local weak_damage_num = Battle.GetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_HP_MAX) * 0.21
  ...
  if Battle.GetCharacterLastCommandSkillID(ENEMY_DIGIMON, 0) == 29211 then

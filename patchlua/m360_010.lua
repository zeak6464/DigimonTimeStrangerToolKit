...
function m360_010()
  ...
  if Debug.IsEventView() then
    ...
    LoadMap("d0702")
    LoadObject("d0702curtain00_01", "d0702curtain00")
    Vista.LoadAnimation("d0702curtain00_01", "e001")
    Vista.LoadAnimation("d0702curtain00_01", "e002")
  end
  ...
  SetPosition("d0702curtain00_01", 0, 8.53, -182.53, "LINEAR", 0, 0)
  SetRotation("d0702curtain00_01", 0, 0, 0, "LINEAR", 0, 0)
  ...
  BlendFace("HERO_01", -10, 0, 0, false, "SCURVE", 40, 0)
  WaitFrame(55)
  CUT("1.0")
  SetEnv_All("c1.0", 0)
  ...
  WaitFrame(30)
  Event_PlaySE(404065, 100, false, 0, 0)
  PlayMotion("chr916_01", "e121", 5, true, 0)
  SetFace("chr916_01", "F01", 0, 1, FACE_BLENDTIME, 0)
  WaitFrame(40)
  if Debug.IsEventView() then
    PlayMotion("d0702curtain00_01", "e001", 5, false, 0)
  else
    Motion.Object:Play(FLD_OBJ_GIMMICK, GetIndex(FLD_OBJ_GIMMICK, "obj_curtain01"), 5, "e001", false)
  end
  Event_PlaySE(404068, 100, false, 0, 0)
  WaitFrame(65)
  CUT("2.0")
  SetEnv_All("c2.0", 0)
  ...
  if Debug.IsEventView() then
    PlayMotion("d0702curtain00_01", "e002", 0, true, 0)
  else
  ...
  Event_PlaySE(400018, 70, false, 0, 0.48)
  ...
  SetCamera(2.669, 20.313, -166.48, 0, 30, "SCURVE", 10, false, 10)
  SetCameraTarget(0.077, 14.262, -172.308, "SCURVE", 10, false, 10)
  ...
  WaitFrame(40)
  Event_Quake_Start(10, 5, 100, 0)
  SetCamera(1.129, 7.205, -159.235, 0, 30, "SCURVE", 10, false, 0)
  SetCameraTarget(-1.096, 13.48, -171.871, "SCURVE", 10, false, 0)

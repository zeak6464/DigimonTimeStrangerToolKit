...
function Battle_After_Build()
  ...
  BASE_LEVEL = Battle.GetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_LV)
end
...
function Battle_Command_Start(info)
  ...
  local digimon_id1 = Battle.GetDigimonId(ENEMY_DIGIMON, 1)
  local digimon_id2 = Battle.GetDigimonId(ENEMY_DIGIMON, 2)
  if Flg.Check("Battle5108") and Flg.Check("Battle5150") and Flg.Check("Battle5111") then
    if digimon_id0 == 976 then
    ...
    elseif digimon_id1 == 976 then
      Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
      Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 2, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
    elseif digimon_id2 == 976 then
      Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
      Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 1, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
    end
  elseif Flg.Check("Battle5108") and Flg.Check("Battle5150") and Flg.Check("Battle5111") == false then
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
    if Flg.Check("Battle5152") == true and digimon_id0 == 973 then
      Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, true)
    end
    if digimon_id2 ~= 999 then
      Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 2, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
    end
  elseif Flg.Check("Battle5108") and Flg.Check("Battle5150") == false and Flg.Check("Battle5111") then
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 2, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
  end
  if Flg.Check("Battle5110") and Flg.Check("Battle5150") and Flg.Check("Battle5111") then
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 1, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 2, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
  elseif Flg.Check("Battle5110") and Flg.Check("Battle5150") and Flg.Check("Battle5111") == false then
    if digimon_id0 == 973 then
      if Flg.Check("Battle5152") == true then
        Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, true)
      else
        Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
      end
      if digimon_id1 == 834 or digimon_id1 == 181 then
        Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 1, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
      end
      if digimon_id2 == 834 or digimon_id2 == 181 then
        Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 2, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
      end
    end
    if digimon_id2 == 999 then
      Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 2, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, true)
      if digimon_id0 == 834 or digimon_id0 == 181 then
        Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
      end
      if digimon_id1 == 834 or digimon_id1 == 181 then
        Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 1, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
  ...
  elseif Flg.Check("Battle5110") and Flg.Check("Battle5150") == false and Flg.Check("Battle5111") then
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 1, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, true)
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 2, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
  elseif Flg.Check("Battle5110") and Flg.Check("Battle5150") == false and Flg.Check("Battle5111") == false then
    Battle.SetCharacterSettingFlag(ENEMY_DIGIMON, 0, BATTLE_CHARACTER_SETTING_REMAIN_HP_1, false)
  end
...
function Battle_Action_End(info)
  ...
  local digimon_id1 = Battle.GetDigimonId(ENEMY_DIGIMON, 1)
  local digimon_id2 = Battle.GetDigimonId(ENEMY_DIGIMON, 2)
  if enemy0_now_hp == 0 and digimon_id0 == 976 then
    Flg.Set("Battle5151")
  end
end
...
function Battle_Turn_End(info)
  ...
  print(Change_max - Change_cnt)
  print(Dissolve_cnt)
  if enemy0_now_hp < 1 and digimon_id0 == 973 then
    Flg.Set("Battle5151")
  end
  if enemy0_now_hp == 1 then
    print("####################index_0##########################")
    ...
    elseif hp1_num == 2 and Change_max - Change_cnt == 1 then
      Flg.Set("Battle5113")
      Flg.Set("Battle5114")
    end
    if digimon_id0 == 973 and Flg.Check("Battle5151") == false then
      Flg.Set("Battle5151")
    elseif digimon_id0 == 999 and Flg.Check("Battle5152") == false then
      Flg.Set("Battle5152")
    end
    if Flg.Check("Battle5151") == true and Flg.Check("Battle5152") == true then
      Flg.Set("Battle5153")
    end
    Battle.ExchangeQueueMember(ENEMY_DIGIMON, 0)
    Flg.Set("Battle5000")
    if Flg.Check("Battle5150") == false and digimon_id0 == 747 then
      Flg.Set("Battle5150")
      Battle.PrepareQueueExchangeByEnemyID(18101, BASE_LEVEL)
    elseif Flg.Check("Battle5153") == true and Flg.Check("Battle5111") == false then
      Flg.Set("Battle5111")
      Battle.PrepareQueueExchangeByEnemyID(83501, BASE_LEVEL)
    elseif Flg.Check("Battle5100") == false then
      Flg.Set("Battle5100")
    ...
    elseif Flg.Check("Battle5108") and Flg.Check("Battle5110") == false and digimon_id0 == 976 then
      Flg.Set("Battle5110")
  ...
  if enemy1_now_hp == 1 then
    ...
    if hp1_num == 2 and Change_max - Change_cnt == 1 then
      Flg.Set("Battle5114")
    end
    if Flg.Check("Battle5113") == true and digimon_id1 ~= 976 then
      Flg.Clear("Battle5113")
      Battle.DeleteMember(ENEMY_DIGIMON, 1)
    else
      Battle.ExchangeQueueMember(ENEMY_DIGIMON, 1)
      Flg.Set("Battle5001")
      if digimon_id1 == 973 and Flg.Check("Battle5151") == false then
        Flg.Set("Battle5151")
      elseif digimon_id1 == 999 and Flg.Check("Battle5152") == false then
        Flg.Set("Battle5152")
      end
      if Flg.Check("Battle5151") == true and Flg.Check("Battle5152") == true then
        Flg.Set("Battle5153")
      end
      if Flg.Check("Battle5150") == false and digimon_id1 == 747 then
        Flg.Set("Battle5150")
        Battle.PrepareQueueExchangeByEnemyID(18101, BASE_LEVEL)
      elseif Flg.Check("Battle5153") == true and Flg.Check("Battle5111") == false then
        Flg.Set("Battle5111")
      ...
      elseif Flg.Check("Battle5107") and Flg.Check("Battle5108") == false then
        Flg.Set("Battle5108")
        Battle.PrepareQueueExchangeByEnemyID(97601, BASE_LEVEL)
      elseif Flg.Check("Battle5108") and Flg.Check("Battle5110") == false and digimon_id1 == 976 then
        Flg.Set("Battle5110")
        Battle.PrepareQueueExchangeByEnemyID(83401, BASE_LEVEL)
      end
    end
  ...
  if enemy2_now_hp == 1 then
    ...
    if Flg.Check("Battle5108") == true and digimon_id2 == 999 then
      if Flg.Check("Battle5151") == true then
        Flg.Clear("Battle5114")
      else
        Flg.Set("Battle5114")
      end
    end
    if digimon_id2 == 973 and Flg.Check("Battle5151") == false then
      Flg.Set("Battle5151")
    elseif digimon_id2 == 999 and Flg.Check("Battle5152") == false then
      Flg.Set("Battle5152")
    end
    if Flg.Check("Battle5151") == true and Flg.Check("Battle5152") == true then
      Flg.Set("Battle5153")
    end
    if Flg.Check("Battle5114") == true and digimon_id2 ~= 976 then
      Flg.Clear("Battle5114")
      Battle.DeleteMember(ENEMY_DIGIMON, 2)
    else
      Battle.ExchangeQueueMember(ENEMY_DIGIMON, 2)
      Flg.Set("Battle5002")
      if Flg.Check("Battle5150") == false and digimon_id2 == 747 then
        Flg.Set("Battle5150")
        Battle.PrepareQueueExchangeByEnemyID(18101, BASE_LEVEL)
      elseif Flg.Check("Battle5153") == true and Flg.Check("Battle5111") == false then
        Flg.Set("Battle5111")
      ...
      elseif Flg.Check("Battle5107") and Flg.Check("Battle5108") == false then
        Flg.Set("Battle5108")
        Battle.PrepareQueueExchangeByEnemyID(97601, BASE_LEVEL)
      elseif Flg.Check("Battle5108") and Flg.Check("Battle5110") == false and digimon_id2 == 976 then
        Flg.Set("Battle5110")
        Battle.PrepareQueueExchangeByEnemyID(83401, BASE_LEVEL)
      end
    end
...
function AddBuffOnExchange(digimon_index)
  local exchange_digimon_id = Battle.GetDigimonId(ENEMY_DIGIMON, digimon_index)
  if exchange_digimon_id == 181 then
    Battle.AddBuff(ENEMY_DIGIMON, digimon_index, 208002)
  elseif exchange_digimon_id == 835 then
    Battle.AddBuff(ENEMY_DIGIMON, digimon_index, 208002)
  elseif exchange_digimon_id == 971 then
    Battle.AddBuff(ENEMY_DIGIMON, digimon_index, 208002)
  elseif exchange_digimon_id == 976 then
    Battle.AddBuff(ENEMY_DIGIMON, digimon_index, 208003)
  elseif exchange_digimon_id == 834 then
    Battle.AddBuff(ENEMY_DIGIMON, digimon_index, 208004)
  end
end

...
local is_highest_difficulty = false
...
function Battle_After_Setup()
  ...
  if Enemy_Lv + 10 > 99 then
    Enemy_Lv = 99
  else
    Enemy_Lv = Enemy_Lv + 10
  end
  Battle.PrepareExchangeByEnemyID(ENEMY_DIGIMON, 0, 93001, Enemy_Lv)
...
function Battle_Start(info)
  ...
  if 70 < enemy_level then
    ...
    Battle.UpgradeSkill(ENEMY_DIGIMON, 0, 30282, 30283)
    Battle.UpgradeSkill(ENEMY_DIGIMON, 0, 30305, 30306)
    if 150000 <= enemy_max_hp then
      is_highest_difficulty = true
    end
  end
end
...
function Battle_Command_Start(info)
  ...
  if enemy_id == 92901 then
    ...
    if 2 <= round_count and 3 <= stock_num then
    ...
    if Battle.IsTurnCharacterExtraTurn() == false then
      ...
      if Flg.Check("Battle5052") and enemy_last_skill_id == 44401 then
        ...
        if Flg.Check("Battle5002") == false then
          ...
          Battle.SetupCPCharge(70003, 93101, ENEMY_DIGIMON, 0, "FP01", 2)
          Flg.Set("Battle5053")
      ...
      if Flg.Check("Battle5053") and Flg.Check("Battle5002") and Round >= 2 then
...
function Battle_Action_Start(info)
  ...
  if enemy_id == 93001 then
    ...
    if Flg.Check("Battle5054") and Flg.Check("Battle5002") == false then
      if Flg.Check("Battle5110") == false then
        ...
        Battle.SkipSkillDirection(ENEMY_DIGIMON, 0, 29302)
      end
    end
  end
  ...
  if info.group == ENEMY_DIGIMON and info.enemy_id == 92901 then
    local skill_id = Battle.GetLastCommandSkillID()
    if skill_id == 29291 and info.use_count == 0 then
...
function Battle_Action_End(info)
  ...
  local enemy_last_skill_id = Battle.GetCharacterLastCommandSkillID(ENEMY_DIGIMON, 0)
  if info.enemy_id == 92901 and enemy_last_skill_id == 29291 then
    Flg.Set("Battle5058")
  end
...
function Battle_Command_End(info)
  ...
  if Flg.Check("Battle5102") == false and (Battle.GetLastActionItemID() == 721 and Item.GetNum(721) == 0 or is_highest_difficulty == true) then
    print("####### ItemUsed #######")
    if Flg.Check("Battle5110") == false and is_highest_difficulty == false then
      print("####### ItemMissed #######")
...
function Battle_Turn_End(info)
  ...
  if Flg.Check("Battle5001") == false then
    ...
    if enemy_now_hp == 1 and Flg.Check("Battle5117") and Flg.Check("Battle5001") == false then
  ...
  if Flg.Check("Battle5001") and Flg.Check("Battle5103") then
    ...
    local weak_damage = enemy_max_hp * 0.05
    if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_WAKE_DAMAGE_VALUE_OVER, 3, ENEMY_DIGIMON, 0, weak_damage) then
      Flg.Set("Battle5015")
    end
    local total_damage = enemy_max_hp * 0.1
    if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_DAMAGE_VALUE_OVER, 3, ENEMY_DIGIMON, 0, total_damage) then
      Flg.Set("Battle5016")
    end
    local total_player_damage = 3000
    if is_high_difficulty then
      total_player_damage = 24000
    end
    if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_PLAYER_SIDE_TOTAL_DAMAGE_VALUE_OVER, 3, ENEMY_DIGIMON, 0, total_player_damage) then
      Flg.Set("Battle5017")
    end
  ...
  if Flg.Check("Battle5056") then
    ...
    CP_Round = 0
    Battle.StopEffectScript(EFF_01, 0)
    if stock_num < 1 and Flg.Check("Battle5206") then
      Battle.RemoveBuff(ENEMY_DIGIMON, 0, 208002)
      Flg.Clear("Battle5206")
    end
    if stock_num < 2 and Flg.Check("Battle5202") then
    ...
    if stock_num < 3 and Flg.Check("Battle5208") then
      if not is_high_difficulty then
        Battle.UpgradeSkill(ENEMY_DIGIMON, 0, 30305, -1)
      end
      Flg.Clear("Battle5208")
    end
    if stock_num < 4 and Flg.Check("Battle5209") then
      Battle.RemoveBuff(ENEMY_DIGIMON, 0, 593006)
      Flg.Clear("Battle5209")
    end
    if stock_num < 5 and Flg.Check("Battle5205") then

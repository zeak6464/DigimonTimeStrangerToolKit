...
function arena_m310_01()
  ...
  LoadModel("enemy_01", "char_PLATINUM_SCUMON")
  LoadModel("enemy_02", "char_TYUMON")
  ...
  SetPosition("enemy_01", 1.971, 0, -8.688, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 90, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -0.529, 0, -6.785, "LINEAR", 0, 0)
  ...
  MessageTalk("arena01_m310_010_010")
  MessageClose()
  WaitFrame(10)
  CUT("2.0")
  SetEnv_All("c3.0", 0)
  ...
  WaitFrame(10)
  MessageTalk("arena01_m310_010_020")
  MessageClose()
  WaitFrame(10)
  CUT("3.0")
  SetEnv_All("c2.0", 0)
  ...
  SetPosition("enemy_01", 1.39, 0, -7.018, "LINEAR", 0, 0)
  ...
  SetCameraTarget(-0.507, 1.035, -6.701, "LINEAR", 0, false, 0, false)
  SetCamera(10.591, 1.01, -4.505, 0, 18, "SCURVE", 60, false, 0, false)
  SetCameraTarget(-0.507, 1.035, -7.771, "SCURVE", 60, false, 0, false)
  SetCamera(10.891, 1.01, -1.265, 0, 18, "LINEAR", 150, true, 60, false)
  SetCameraTarget(-0.507, 1.035, -7.821, "LINEAR", 150, true, 60, false)
  WaitFrame(10)
  MessageTalk("arena01_m310_010_030")
  MessageClose()
  WaitFrame(10)
  CUT("4.0")
  SetEnv_All("c2.0", 0)
  ModelVisible("enemy_01", true, 0, 0)
  ModelVisible("enemy_02", true, 0, 0)
  SetPosition("enemy_01", 0.627, 0, -6.84, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 0, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -1.6, 0, -6.84, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 2.5, 0, "LINEAR", 0, 0)
  SetCamera(-0.28, 0.91, -2.89, 0, 45, "LINEAR", 0, true, 0, false)
  SetCameraTarget(-0.81, -0.32, -12.8, "LINEAR", 0, true, 0, false)
  WaitFrame(10)
  PlayMotion("enemy_02", "fe04", 10, false, 0)
  PlayMotion("enemy_02", "bn01", 10, true, 80)
  WaitFrame(10)
  SetFace("enemy_02", "F03_M01", 0, 2, FACE_BLENDTIME, 0)
  MessageTalk("arena01_m310_010_040")
  SetFace("enemy_02", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(10)
  ...
  WaitFrame(10)
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageTalk("arena01_m310_010_041")
  SetFace("enemy_01", "F03", 0, 1, FACE_BLENDTIME, 0)
  MessageClose()
  WaitFrame(20)
  CUT("5.0")
  ...
  SetPosition("enemy_01", 2.5, 0, -5.219, "LINEAR", 0, 0)
  ...
  Vista.ApplyVoiceSnapshot(SOUND_SNAPSHOT_MIC)
  MessageTalk("arena01_m310_010_050")
  MessageClose()
  WaitFrame(15)

...
function Battle_Start(info)
  ...
  if 50 < enemy_level then
    ...
    Enemy_Lv = enemy_level
    Battle.UpgradeSkill(ENEMY_DIGIMON, 1, 30232, 30233)
  end
end
...
function Battle_Turn_Start(info)
  ...
  if Flg.Check("Battle5153") then
    if Flg.Check("Battle5154") then
      j = 4
    else
      j = 2
    end
    for i = 1, j do
      local max_hp = Battle.GetStatus(ENEMY_DIGIMON, i, STATUS_TYPE_HP_MAX)
      Battle.SetStatus(ENEMY_DIGIMON, i, STATUS_TYPE_HP, max_hp * 0.67)
      print("... i = ", i, ", hp = ", max_hp * 0.67, " ...")
    end
    Flg.Clear("Battle5153")
  end
  if Flg.Check("Battle5154") then
    math.randomseed(os.time())
    local target_idx = math.random(1, 4)
    Battle.SetNextCommandSkill(ENEMY_DIGIMON, target_idx, 10012)
    print("... target_idx = ", target_idx)
    j = 4
    Flg.Clear("Battle5154")
  end
end
...
function Battle_Command_Start(info)
  ...
  print("Round:", Round)
  if Flg.Check("Battle5053") == false and Flg.Check("Battle5155") == false then
...
function Battle_Turn_End(info)
  ...
  if Flg.Check("Battle5053") == false then
    if 1 <= stock_num and Flg.Check("Battle5155") == false then
      LotteryExtraTurnUnit()
    else
      for idx = 1, 4 do
        if IsCheckTarget(ENEMY_DIGIMON, idx, REGION_FLAG_TYPE_MECHANICAL) == true then
          Battle.SetExtraTurn(ENEMY_DIGIMON, idx, false)
        end
      end
    end
  end

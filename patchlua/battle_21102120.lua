...
function Battle_Command_Start(info)
  if Flg.Check("Battle5051") then
    Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 26883)
...
function Battle_Turn_End(info)
  ...
  if Battle.IsAccomplishConditionType2(BATTLE_CONDITION_TYPE_DAMAGE_MAGNIFICATION_BELOW, 3, ENEMY_DIGIMON, 0, 3, 200, true) then
    Flg.Set("Battle5015")
  end
  ...
  if Battle.GetCharacterLastCommandSkillID(ENEMY_DIGIMON, 0) == 26883 then

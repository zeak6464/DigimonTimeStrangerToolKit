...
function Battle_Turn_End(info)
  ...
  if Battle.IsAccomplishConditionType2(BATTLE_CONDITION_TYPE_DAMAGE_MAGNIFICATION_BELOW, 1, ENEMY_DIGIMON, 0, 2, 100, false) then
    Flg.Set("Battle5015")
  end
  if Battle.IsAccomplishCondition(BATTLE_CONDITION_TYPE_DAMAGE_MAGIC, 3, ENEMY_DIGIMON, 0, 6) then
    Flg.Set("Battle5016")
  end
  local weak_damage_num = Battle.GetStatus(ENEMY_DIGIMON, 0, STATUS_TYPE_HP_MAX) * 0.22

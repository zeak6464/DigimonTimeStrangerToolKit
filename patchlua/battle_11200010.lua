...
function Battle_Start(info)
  ...
  if 70 < enemy_level then
    ...
    Battle.UpgradeSkill(ENEMY_DIGIMON, 0, 29167, 31012)
    Battle.UpgradeSkill(ENEMY_DIGIMON, 0, 29165, 31012)
    Battle.UpgradeSkill(ENEMY_DIGIMON, 0, 29166, 31022)
  end
end
...
function Battle_Turn_Start(info)
  ...
  if Flg.Check("Battle5102") == false and info.group == GUEST_DIGIMON and info.index == 0 and Flg.Check("Battle5113") == false and Flg.Check("Battle5052") == false and Flg.Check("Battle5053") == false and Flg.Check("Battle5110") == false and 2 <= info.round then
    if Flg.Check("Battle5123") == false then
      for idx = 0, 2 do
        if 0 < Battle.GetDigimonId(PLAYER_DIGIMON, idx) and 1 <= Battle.GetCountdownDeathRevivalCount(PLAYER_DIGIMON, idx) then
          Flg.Set("Battle5123")
        end
      end
    end
    if Flg.Check("Battle5115") or Flg.Check("Battle5123") then
...
function Battle_Command_Start(info)
  ...
  for idx = 0, 2 do
    if 0 < Battle.GetDigimonId(PLAYER_DIGIMON, idx) and 0 < Battle.GetStatus(PLAYER_DIGIMON, idx, STATUS_TYPE_HP) then
      target_list[#target_list + 1] = idx
    end
  end
  local target_idx = target_list[math.random(1, #target_list)]
  if enemy_id == 91601 and Flg.Check("Battle5051") == false and Flg.Check("Battle5052") == false and Flg.Check("Battle5116") == false and Flg.Check("Battle5110") == false and Battle.IsBuff(1, 0, 105000, BUFF_CHECK_OR_WITHOUT_ID) then
    Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, 29167)
  ...
  if enemy_id == 91601 then
    if Flg.Check("Battle5051") and Flg.Check("Battle5052") == false and Flg.Check("Battle5116") then
      Flg.Set("Battle5052")
    end
    if Flg.Check("Battle5052") and Flg.Check("Battle5053") == false then
  ...
  if Round == 2 and Flg.Check("Battle5053") and enemy_id == 91601 then
    local charge_end_skill_id = 70009
    local charge_break_num = 0
    for i = 0, 3 do
      if Battle.GetStatus(ADD_TARGET, i, STATUS_TYPE_HP) == 0 then
        charge_break_num = charge_break_num + 1
      end
    end
    if charge_break_num == 1 then
      charge_end_skill_id = 70017
    elseif charge_break_num == 2 then
      charge_end_skill_id = 70018
    elseif charge_break_num == 3 then
      charge_end_skill_id = 70019
    end
    Battle.SetNextCommandSkill(ENEMY_DIGIMON, 0, charge_end_skill_id)
    Battle.CompleteCPCharge(70005)
  end
  if skill_id == 70009 and Flg.Check("Battle5110") then
  ...
  elseif skill_id == 70009 or skill_id == 70017 or skill_id == 70018 or skill_id == 70019 then
...
function Battle_Action_Start(info)
  ...
  if info.group == ENEMY_DIGIMON and info.enemy_id == 91601 and Battle.GetLastCommandSkillID() == 29161 and info.use_count == 0 then
...
function Battle_Turn_End(info)
  ...
  if Flg.Check("Battle5110") == false and (last_skill_id == 70009 or last_skill_id == 70017 or last_skill_id == 70018 or last_skill_id == 70019) then
    AddTarget_nobreakHP()
  ...
  if Flg.Check("Battle5120") == false then
    for idx = 0, 2 do
      if 0 < Battle.GetDigimonId(PLAYER_DIGIMON, idx) and 2 <= Battle.GetCountdownDeathRevivalCount(PLAYER_DIGIMON, idx) then
        print("##### COUNT DOWN DEATH TWICE index = ", idx, " #####")
        Flg.Set("Battle5120")
        break
      end
    end

function OnCheckNPC(npc)
  ...
  if gMapNum == 3001 then
    if talk_id == 501 then
      ...
      elseif Common.CheckTimeAxis("A2020_dbef_119") or Common.CheckTimeAxis("A2020_dbef_199") then
  ...
  elseif gMapNum == 3003 then
    ...
    if talk_id == 301 then
      ...
      elseif Qst.Sub:Check(S100_087.ID, S100_087.STEP_010, S100_087.STEP_255) then
        S100_087:Event_015()
      elseif Qst.Sub:Check(S100_087.ID, S100_087.STEP_005, S100_087.STEP_010) then
        S100_087:Event_017()

...
function Battle_Action_Start(info)
  ...
  skill_id = Battle.GetLastCommandSkillID()
  if info.group == ENEMY_DIGIMON and info.enemy_id == 97301 and skill_id == 21733 and info.use_count == 0 then
    Battle.SetBattleSpeedToNormalForTurn()
  end
  if (skill_id == 21734 or skill_id == 21735 or skill_id == 21736) and info.use_count == 0 then
    Battle.SetBattleSpeedToNormalForTurn()
  end
end
...
function Battle_Turn_End(info)
  ...
  elseif stock_num == 3 and round_count % 2 == 1 then
    Battle.SetExtraTurn(ENEMY_DIGIMON, 0, true)
    Battle.SetExtraTurnNextCommandSkill(ENEMY_DIGIMON, 0, 30276)

...
function arena_f001_12()
  ...
  ModelVisible("enemy_02", true, 0, 0)
  ModelVisible("enemy_03", true, 0, 0)
  SetPosition("enemy_01", -7.518, 0, -1.7, "LINEAR", 0, 0)
  SetRotation("enemy_01", 0, 90, 0, "LINEAR", 0, 0)
  SetPosition("enemy_02", -9.795, 0, 0.529, "LINEAR", 0, 0)
  SetRotation("enemy_02", 0, 101.5, 0, "LINEAR", 0, 0)
  SetPosition("enemy_03", -6.808, 0, 1.786, "LINEAR", 0, 0)
  SetRotation("enemy_03", 0, 105, 0, "LINEAR", 0, 0)
  SetCamera(-2.808, 2.908, -0.571, 0, 45, "LINEAR", 0, true, 0, false)
  SetCameraTarget(-14.214, 0.35, 0.764, "LINEAR", 0, true, 0, false)
  WaitFrame(10)
